...
from MultiDofFollowJointTrajectory.msg import MultiDofFollowJointTrajectoryAction, \
    MultiDofFollowJointTrajectoryGoal, MultiDofJointTrajectory, MultiDofJointTrajectoryPoint
